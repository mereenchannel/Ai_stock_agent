                ...
                if df.empty:
                    ...
                    try:
                        ...
                        if not api_key:
                            ...
                            5. **กลยุทธ์ Take Profit (สำคัญมาก):** เนื่องจากเราเป็นสายรันเทรนด์ (Let Profit Run)
                               - ห้ามกำหนดจุด TP เป็นตัวเลขตายตัวที่จำกัดกำไร (No Fixed TP)
                               - ให้ใช้กลยุทธ์ "Trailing Stop" แทน โดยแนะนำให้ถือหุ้นไปเรื่อยๆ และจะสั่งขาย (SELL) ก็ต่อเมื่อราคาปิดหลุดเส้น EMA_20 (สำหรับระยะสั้น) หรือ EMA_50 (สำหรับระยะกลาง)
                               - ให้เพิ่มคำแนะนำ "การแบ่งขายทำกำไร (Partial Take Profit)" หากพบว่าค่า MCDX ของรายใหญ่ในรอบ 5 วันล่าสุด ลดลงอย่างรุนแรงจนต่ำกว่า 45 ทั้งที่ราคายังขึ้นอยู่ (เกิด Bearish Divergence ระหว่างราคากับเงินทุน)
                               
                            6. การตั้ง Stop Loss (SL): ต้องกำหนดตัวเลขจุดตัดขาดทุนที่ชัดเจนเสมอเมื่อสั่ง BUY โดยอ้างอิงจากเส้น EMA หรือจุดต่ำสุดเดิม เพื่อจำกัดความเสี่ยง
