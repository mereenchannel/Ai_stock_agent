                ...
                if df.empty:
                    ...
                    try:
                        ...
                        if not api_key:
                            ...
                            4. การประเมินความคุ้มค่า (Risk:Reward & Entry Logic) **สำคัญมาก**:
                               - ประเมินระยะห่างระหว่าง 'ราคาปัจจุบัน' กับ 'เส้น EMA_20'
                               - หากราคาปัจจุบันอยู่ห่างจาก EMA_20 มากเกินไป (Overextended) การเข้าซื้อทันทีจะทำให้ Risk/Reward ไม่คุ้มค่า ห้ามแนะนำให้ซื้อที่ราคาปัจจุบัน (No FOMO)
                               - หากเป็นกรณี Overextended ให้เปลี่ยนคำแนะนำเป็น "WAIT (รอราคาย่อตัว)" หรือ แนะนำจุดเข้าซื้อแบบ "Limit Buy" ที่บริเวณใกล้เคียงกับเส้น EMA_20 แทน
                               - จะแนะนำให้ซื้อที่ราคาปัจจุบัน (Market Buy) ได้ก็ต่อเมื่อ ราคายังคลอเคลียอยู่ใกล้เส้น EMA_20 หรือเพิ่งเกิดจุดตัด (Breakout) ที่ความเสี่ยงยังต่ำอยู่เท่านั้น
